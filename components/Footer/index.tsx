        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-9 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-4 inline-block">
             
                  <Image
                   src="/images/logo/phx.png"
                   alt="logo"
                   width={140}
                   height={30}
                ...
                <p className="dark:text-body-color-dark mb-9 mt-0 text-base leading-relaxed text-body-color">
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  ...
                  <li>
                    <a
                    target="blank"
                      href="https://www.google.com/maps/dir//Dhurga+Nagar,+Karamana,+Thiruvananthapuram,+Kerala+695002/@8.4813588,76.8826796,12z/data=!4m8!4m7!1m0!1m5!1m1!1s0x3b05bbe3fec7cefb:0x9ee93411f1679beb!2m2!1d76.9650815!2d8.4813674?entry=ttu&g_ep=EgoyMDI1MDIwMi4wIKXMDSoASAFQAw%3D%3D"
                      className="dark:text-body-color-dark mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                    >
                     Map
                    </a>
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
             Developed by {" "}
              <a target="blank" href="https://orcat.in" rel="nofollow noopener">
                Orca Technologies
              </a>
            </p>
          </div>
