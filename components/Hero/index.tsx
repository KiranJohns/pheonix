...
const Hero = () => {
  ...
  return (
    <>
      <section
        id="home"
        className="dark:bg-black relative z-10 overflow-hidden bg-red-700 pb-16 pt-[120px] md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px]"
      >
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div
                ...
                data-wow-delay=".2s"
              >
                <h1 className="mb-5 text-3xl font-bold leading-tight text sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                ...
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0 ">
                  <Link
                    href=""
                    className="rounded-sm bg-red-500 px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-red-400 "
                  >
                    Call Now
                  </Link>
                  <Link
                    href=""
                    className="inline-block rounded-sm bg-black px-8 py-4 text-base font-semibold text-orange-400 duration-300 ease-in-out hover:bg-gray-500 dark:bg-black dark:text-orange-400 dark:hover:bg-gray-900"
                  >
                   Message
                  </Link>
                </div>
