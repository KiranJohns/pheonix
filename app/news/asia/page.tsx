...
import NewCarousel from '@/components/Carousal/NewCarousal';
        ...
        <section className="relative h-screen">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white z-10 px-4 bg-black/30 ">
            ...
            >
              ...
              >
                Introducing Next-Level Technology
              </motion.span>
              <motion.h1 
              ...
              >
                Discover a new dimension of interaction with our beautifully crafted interfaces 
                and meticulously engineered technology.
              </motion.p>
              <motion.div 
              ...
              >
                ...
                <Button 
                  variant="outline" 
                  className="bg-white/10 backdrop-blur-md hover:bg-white/20 text-white border-white/20 px-8 py-6 rounded-full text-lg"
                >
                  Learn More
                </Button>
              </motion.div>
